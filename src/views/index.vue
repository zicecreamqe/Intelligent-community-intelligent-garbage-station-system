  ...
  <div class="app-container home">
    ...
    <el-row :gutter="20">
      <el-col :sm="24" :lg="12" style="padding-left: 20px">
        <h2>智慧社区智能垃圾站系统</h2>
        <p><a href="javascript:void(0);" target="_blank">智慧社区智能垃圾站系统</a>是一套开源的软硬件系统，可用于二次开发和学习，快速搭建自己的智能家居系统。 硬件工程师可以把自己的设备集成到系统；软件工程师可以使用项目中的设备熟悉软硬件交互。</p>
        ...
        <p>
          ...
          <el-button
            ...
            icon="el-icon-s-home"
            plain
            @click="goTarget('https://baidu.com')"
            >访问主页</el-button
          >
        </p>
      </el-col>
